...
# --- Regenerated styling and type-based coloring ---
bg_color white
set antialias, 2
set depth_cue, 0
set fog, 0
...
set cartoon_transparency, 0.55, original
hide lines, all
hide nonbonded, all
hide labels, all

# Normalize chain naming to ioNERDSS convention
alter original and chain A, chain='A0'
alter original and (chain AA or chain a), chain='A1'
alter original and chain B, chain='B0'
alter original and (chain BA or chain b), chain='B1'
alter coarse_grained and chain A, chain='A0'
alter coarse_grained and (chain AA or chain a), chain='A1'
alter coarse_grained and chain B, chain='B0'
alter coarse_grained and (chain BA or chain b), chain='B1'
sort
rebuild
...
show cartoon, original
hide everything, coarse_grained
show spheres, coarse_grained and name COM
show spheres, coarse_grained and name INT
set sphere_scale, 0.7, coarse_grained and name COM
set sphere_scale, 0.45, coarse_grained and name INT
color red, coarse_grained and name INT
color red, int_*

# Interface spokes and edges
color yellow, interface*
set dash_gap, 0.0, interface*
set dash_width, 4.0, interface*
color yellow, line*
set dash_gap, 0.15, line*
set dash_width, 2.0, line*

set_color type_A0, [0.894, 0.102, 0.11]
set_color type_A1, [0.216, 0.494, 0.722]
set_color type_B0, [0.302, 0.686, 0.29]
set_color type_B1, [0.596, 0.306, 0.639]
set_color type_C, [1.0, 0.498, 0.0]
set_color type_D, [1.0, 1.0, 0.2]
set_color type_E, [0.651, 0.337, 0.157]
set_color type_F, [0.969, 0.506, 0.749]
set_color type_G, [0.6, 0.6, 0.6]
set_color type_H, [0.121, 0.47, 0.705]
set_color type_I, [0.698, 0.874, 0.541]
set_color type_J, [0.992, 0.749, 0.435]
set_color type_K, [0.792, 0.698, 0.839]
set_color type_L, [0.4, 0.761, 0.647]
color type_A0, original and chain A0+O
color type_A0, coarse_grained and chain A0+O
color type_A0, com_A0 or com_O
color type_A1, original and chain A1+M
color type_A1, coarse_grained and chain A1+M
color type_A1, com_A1 or com_M
color type_B0, original and chain B0+P
color type_B0, coarse_grained and chain B0+P
color type_B0, com_B0 or com_P
color type_B1, original and chain B1+N
color type_B1, coarse_grained and chain B1+N
color type_B1, com_B1 or com_N
color type_C, original and chain C+Q
color type_C, coarse_grained and chain C+Q
color type_C, com_C or com_Q
color type_D, original and chain D+R
color type_D, coarse_grained and chain D+R
color type_D, com_D or com_R
color type_E, original and chain E+S
color type_E, coarse_grained and chain E+S
color type_E, com_E or com_S
color type_F, original and chain F+T
color type_F, coarse_grained and chain F+T
color type_F, com_F or com_T
color type_G, original and chain G+U
color type_G, coarse_grained and chain G+U
color type_G, com_G or com_U
color type_H, original and chain H+V
color type_H, coarse_grained and chain H+V
color type_H, com_H or com_V
color type_I, original and chain I+W
color type_I, coarse_grained and chain I+W
color type_I, com_I or com_W
color type_J, original and chain J+X
color type_J, coarse_grained and chain J+X
color type_J, com_J or com_X
color type_K, original and chain K+Y
color type_K, coarse_grained and chain K+Y
color type_K, com_K or com_Y
color type_L, original and chain L+Z
color type_L, coarse_grained and chain L+Z
color type_L, com_L or com_Z
